...
import com.jungel.coinoffline.eos.eospocket.service.KillSelfService;
//
...
//                .title(context.getResources().getString(R.string.pocket_dear_user))
//                .msg(msg)
...
//                        ToastUtils.showShortToast(context.getResources().getString(R.string.pocket_close_permisson_toast));
//                    }
//
//                    @Override
