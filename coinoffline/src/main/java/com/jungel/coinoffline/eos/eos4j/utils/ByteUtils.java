...
public class ByteUtils {
    ...
    public static byte[] writerUnit32(String value) {
        ...
        if (l > Integer.MAX_VALUE) {
            byte[] b = ByteBuffer.allocate(Long.BYTES).order(ByteOrder.LITTLE_ENDIAN).putLong(l)
					.array();
            int j = 0;
            ...
            return ByteBuffer.allocate(Integer.BYTES).order(ByteOrder.LITTLE_ENDIAN).putInt
    ...
    public static byte[] writeName(String v) {
        ...
        return ByteBuffer.allocate(Long.BYTES).order(ByteOrder.LITTLE_ENDIAN).putLong(ulName
				.longValue()).array();
    }
    ...
    public static byte[] writerKey(String key) {
        com.jungel.coinoffline.eos.eos4j.utils.ByteBuffer bf = new com.jungel.coinoffline.eos.eos4j.utils.ByteBuffer();
