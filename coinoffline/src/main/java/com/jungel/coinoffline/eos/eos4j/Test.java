...
public class Test {
	...
	public static void main(String[] args){
		...
		String pk = Ecc.seedPrivate("!@#$%^&*(lajdlkjaksjdlkjaskldM<>?87126162kajsdjlaksd " +
				"kajdlkaslkd heiuheijpe f[a- si0ausd9asd ahsdvcyasdcasdc ajhsdg8ca"
				+ "we asds JHDKAHDKKASDKJALSKDKA ooidjajsdua09sid0asdo[paksdajsdlklasdmlk " +
				"FJKLIKNLK;B/;LP[P'NC;PO'; OOPO;L0["
				+ "XP'C'[FG["
				+ "19218728909107328972309289832098012");
		System.out.println("private key :" + pk + "\n");
		System.out.println("private key :" + "5JYgcuybUYKAuqrx9QZFUsDWiMh31DH1soFwKcyWuoq9oD5Fb22" + "\n");
		System.out.println("private key is same:" + "5JYgcuybUYKAuqrx9QZFUsDWiMh31DH1soFwKcyWuoq9oD5Fb22".equalsIgnoreCase(pk) + "\n");

		System.out.println("============= 通过私钥生成公钥 ===============");
		String pu = Ecc.privateToPublic(pk);
		System.out.println("public key :" + pu + " \n ");
		System.out.println("public key :" + "EOS7Wz4yF2HMQKuDPEVJEgw91D6Y1ycqUPHpWrpmdPWCDQuGPSFef" + " \n ");
		System.out.println("public key is same :" + "EOS7Wz4yF2HMQKuDPEVJEgw91D6Y1ycqUPHpWrpmdPWCDQuGPSFef".equalsIgnoreCase(pu) + " \n ");
...
//					"espritblocke", "testnetyy111", "testneths111", "12.2821 MSP", "");
...
//		try {
//			Transaction t3 = rpc.createAccount
//					("5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3", "eosio",
//							"bbbb..54321",
//							"EOS8eAX54cJtAngV2V22WZhRCW7e4sTAZz1mC5U22vp8mAGuFdMXx" +
//									"", "EOS8eAX54cJtAngV2V22WZhRCW7e4sTAZz1mC5U22vp8mAGuFdMXx",
...
//			rpc.voteproducer("5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3",
//					"epskdkdsddss", "iuewjdkslsdc", produces);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//
...
//		try {
//			rpc.close("5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3", "合约账户", "关闭账户",
//					"0.0000 IPOS");
