...
public class Ecc {
     ...
     * @return
     */
    public static String signTransaction(String privateKey, TxSign sign, int type) {
        return EccTool.signTransaction(privateKey, sign, type);
    }
     ...
     * @return
     */
    public static String parseVoteProducerData(String voter, String proxy, List<String>
            producers) {
     ...
     * @return
     */
    public static String parseAccountData(String creator, String name, String onwer, String
            active) {
     ...
     * @return
     */
    public static String parseBuyRamData(String from, String receiver, String stakeNetQuantity,
